...
/* harmony import */ var _modules_modals_about__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/modals/about */ "./js/modules/modals/about.js");
/* harmony import */ var _modules_modals_footer_accordion__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/modals/footer-accordion */ "./js/modules/modals/footer-accordion.js");
/* harmony import */ var _modules_modals_question__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/modals/question */ "./js/modules/modals/question.js");
/* harmony import */ var _modules_modals_question_modal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/modals/question-modal */ "./js/modules/modals/question-modal.js");
...
Object(_modules_modals_about__WEBPACK_IMPORTED_MODULE_2__["aboutButtonHandler"])();
Object(_modules_modals_footer_accordion__WEBPACK_IMPORTED_MODULE_3__["getChangeAccordion"])();
Object(_modules_modals_question__WEBPACK_IMPORTED_MODULE_4__["formValid"])();
Object(_modules_modals_question_modal__WEBPACK_IMPORTED_MODULE_5__["modalValid"])(); // ---------------------------------
...
/*!************************************!*\
  !*** ./js/modules/modals/about.js ***!
  \************************************/
/*! exports provided: aboutButtonHandler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aboutButtonHandler", function() { return aboutButtonHandler; });
var aboutOptionalText = document.querySelector('.about__optional-text');
var aboutOptionalTextMobile = document.querySelector('.about__optional-text-mobile');
var aboutButton = document.querySelector('.about__button');
var aboutInformationWrapper = document.querySelector('.about__information-wrapper');

var aboutButtonHandler = function aboutButtonHandler() {
...
/*!***********************************************!*\
  !*** ./js/modules/modals/footer-accordion.js ***!
  \***********************************************/
/*! exports provided: getChangeAccordion */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getChangeAccordion", function() { return getChangeAccordion; });
var pageFooter = document.querySelector('.page-footer__wrapper');
pageFooter.classList.remove('page-footer__wrapper--nojs');

function hideAll() {
  var TitleList = pageFooter.querySelectorAll('.page-footer__accordion-handler');
...
var getChangeAccordion = function getChangeAccordion() {
  if (window.screen.width < 768) {
    pageFooter.addEventListener('click', function (evt) {
...
/*!***********************************!*\
  !*** ./js/modules/modals/form.js ***!
  \***********************************/
/*! exports provided: enterCheckbox */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "enterCheckbox", function() { return enterCheckbox; });
// функция выключает кнопку отправки форму при ненажатом чекбоксе
var enterCheckbox = function enterCheckbox(userCheckbox, buttonHandler) {
...
/*!*********************************************!*\
  !*** ./js/modules/modals/question-modal.js ***!
  \*********************************************/
/*! exports provided: modalValid */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "modalValid", function() { return modalValid; });
/* harmony import */ var _form__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./form */ "./js/modules/modals/form.js");
/* harmony import */ var imask__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! imask */ "../node_modules/imask/esm/index.js");


var buttonForm = document.getElementById('question-button');
var checkboxForm = document.getElementById('personal-data-modal');
var modalName = document.querySelector('.modal-question__item--name input');
var modalPhone = document.getElementById('modal-input-phone');
var maskOptions = {
  mask: '+{7}(000)000-00-00'
};

var modalValid = function modalValid() {
  checkboxForm.addEventListener('click', function () {
    Object(_form__WEBPACK_IMPORTED_MODULE_0__["enterCheckbox"])(checkboxForm, buttonForm);
  });
  document.addEventListener('DOMContentLoaded', function () {
    Object(imask__WEBPACK_IMPORTED_MODULE_1__["default"])(modalPhone, maskOptions);
  });
  modalName.focus();
};
...
var userCheckbox = document.querySelector('.form__checkbox input');
var buttonHandler = document.getElementById('form-button');
...
var formValid = function formValid() {
  userCheckbox.addEventListener('click', function () {
    Object(_form__WEBPACK_IMPORTED_MODULE_0__["enterCheckbox"])(userCheckbox, buttonHandler);
  });
  document.addEventListener('DOMContentLoaded', function () {
    Object(imask__WEBPACK_IMPORTED_MODULE_1__["default"])(inputElement, maskOptions);
  });
};
