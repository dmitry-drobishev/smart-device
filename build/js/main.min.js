...
userCheckbox.addEventListener('click', _modules_modals_form__WEBPACK_IMPORTED_MODULE_4__["enterCheckbox"]);
...
/*!***********************************!*\
  !*** ./js/modules/modals/form.js ***!
  \***********************************/
/*! exports provided: enterCheckbox, enterUserPhone */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "enterCheckbox", function() { return enterCheckbox; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "enterUserPhone", function() { return enterUserPhone; });
var telRegexp = /^((8|\+7)[\- ]?)?(\(?\d{3}\)?[\- ]?)?[\d\- ]{7,10}$/;
var userPhoneInput = document.querySelector('.form__item--phone input');
var userCheckbox = document.querySelector('.form__checkbox input');
var buttonHandler = document.getElementById('form-button');

var enterUserPhone = function enterUserPhone() {
...
var enterCheckbox = function enterCheckbox() {
