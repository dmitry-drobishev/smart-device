...
Object(_modules_modals_question__WEBPACK_IMPORTED_MODULE_4__["formValid"])(); // MASK
// ---------------------------------

document.addEventListener('DOMContentLoaded', function () {
  var inputElement = document.getElementById('modal-input-phone');
  var maskOptions = {
    mask: '+{7}(000)000-00-00'
  };
  Object(imask__WEBPACK_IMPORTED_MODULE_5__["default"])(inputElement, maskOptions); // запускаем плагин с переданными параметрами
}); // ---------------------------------
...
function hideAll() {
  var TitleList = pageFooter.querySelectorAll('.accordion__handler');
...
/* harmony import */ var _question_modal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./question-modal */ "./js/modules/modals/question-modal.js");
...
var settings = {
  'default': {
    ...
    focusBack: true,
    eventTimeout: 400,
    openCallback: _question_modal__WEBPACK_IMPORTED_MODULE_1__["modalValid"],
    closeCallback: false
  }
};
